...
export default function CadastroProfessor() {
    ...
    function showAlertErro(errors){
        console.log("errors: "+JSON.stringify(errors))
        Alert.alert(    
            "Ocorreu um Erro!",
            errors.length > 1 ? "Os campos " + errors.map((element)=>{return element + ", "}) + "estão vazios! Favor preencher.": "O campo " + errors.error[0] + "está vazio! Favor preencher",
            [
                {
                    text: "Fechar",
                    style: "color:'#FFFFFF'",
